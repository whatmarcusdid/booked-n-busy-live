  ...
  try {
    ...
    const { data: result, error } = await supabase.rpc(
      "create_audit_with_lead",
      {
        ...
        p_primary_trade: data.primaryTrade ?? null,
        p_secondary_trades: data.secondaryTrades ?? null,
        p_business_model: data.businessModel ?? null,
        p_audit_focus: data.auditFocus ?? null,
